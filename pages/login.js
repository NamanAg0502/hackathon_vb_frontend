const Login = () => {
  return (
    <div className="min-h-screen bg-gray-50 w-full my-12">
      <div className="flex flex-col items-center justify-center w-3/4 mx-auto border">
        <div className="grid grid-cols-2 w-full">
          <div className="bg-white p-6 flex flex-col items-center">
            <h1 className="text-black font-semibold text-3xl">Client Login</h1>
            <form className="mt-8 space-y-6 w-3/4" action="#" method="POST">
          ...
          <div className="bg-indigo-600 p-6 flex flex-col items-center">
            <h1 className="text-white font-semibold text-3xl">Lawyer Login</h1>
            <form className="mt-8 space-y-6 w-3/4" action="#" method="POST">
              <input type="hidden" name="remember" defaultValue="true" />
              <div className="-space-y-px rounded-md shadow-sm ">
                <div>
